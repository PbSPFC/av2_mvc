...
<%    try {
        ...
        mensagens = mensagemDAO.getListaMensagensBy("id_destinatario", id);
%>
    ...
    <div class="table-responsive">
        <div class="panel panel-primary ">
            <div class="panel-heading">
                <h2 class="panel-title h1">Mensagens Recebidas: <%= mensagemDAO.getTotalRegistros()%>
                    &nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;
                ...
                <table class="table table-responsive">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Todas Mensagens</th>
                        </tr>
                    </thead>
                    <tbody>                    
                        <%
                        ...
                        <tr>
                            ...
                            <td><%= mensagem.getIdUsuario()%></td>
                            <td><%= mensagem.getRemetente()%></td>
                            <td><%= mensagem.getAssunto()%></td>
                            <td class="text-center"><a href="showMensagemUnica.jsp?idMensagem=<%= mensagem.getId()%>&idUsuario=<%= mensagem.getIdUsuario()%>&tipo=cxe&pg=cxEntrada" class="glyphicon glyphicon-eye-open"></a></td>
                            <td class="text-center"><a href="showMensagem.jsp?idMensagem=<%= mensagem.getId()%>&idUsuario=<%= mensagem.getIdUsuario()%>&tipo=cxe&pg=cxEntrada">Todas</a></td>
                        </tr>
                        <%
                                }
                            } catch (Exception e) {
